...
function baseStructuralRules(): Record<RuleCode, RuleConfig> {
  return {
    ...
    RULE_COMPAT_CONTACT_WIRE: DISABLED,
    RULE_COMPAT_MODULE_CONTACT: DISABLED,
    RULE_COMPAT_MODULE_BACKSHELL: DISABLED,
    RULE_COMPAT_MODULE_STRAIN_RELIEF: DISABLED,
    RULE_COMPAT_FRAME_MODULE: DISABLED
  };
}
...
const RULES_2026_04: Record<RuleCode, RuleConfig> = {
  ...
  RULE_COMPAT_CONTACT_WIRE: FULL_ONLY_ERROR,
  RULE_COMPAT_MODULE_CONTACT: FULL_ONLY_ERROR,
  RULE_COMPAT_MODULE_BACKSHELL: FULL_ONLY_ERROR,
  RULE_COMPAT_MODULE_STRAIN_RELIEF: FULL_ONLY_ERROR,
  RULE_COMPAT_FRAME_MODULE: FULL_ONLY_ERROR
};
